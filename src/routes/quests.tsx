        ...
        <section className="mb-8 sm:mb-12">
          <div className="grid grid-cols-1 min-[380px]:grid-cols-[minmax(0,1fr)_auto] sm:flex sm:items-center sm:justify-between gap-3 mb-4 sm:mb-6 min-w-0">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-3.5 py-2 rounded-lg bg-card border border-border hover:bg-secondary text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed transition-base w-full min-[380px]:w-auto min-h-[44px]"
            >
